...
If you still need to gain basic working knowledge of using bash and the commandline (terminal), then see the following [tutorials](prerequisites.html#resources) in the resources section before following these steps.
:::
