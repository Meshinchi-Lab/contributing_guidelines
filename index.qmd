...
If you still need to gain basic working knowledge of using bash and the commandline (terminal), then see the following [tutorial](https://www.coursera.org/learn/cli---command-line-basics) before following the steps outlined here.
:::
